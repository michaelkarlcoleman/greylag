...
def get_spectrum_info(options, spectra):
    ...
    generated by 'generate_spectra_from_files'.  Spectra not meeting criteria
    such as options.minimum_trypticity and options.maximum_sp_rank are
    dropped.
    """

    # [ (spectrum_no, charge, score, delta, state, peptide, stripped_peptide,
    #    actual_mass, mass_delta, loci), ... ]
    spectrum_info = []
...
def try_fdr(fdr_guess, options, remaining_spectrum_info, saturation_spectrum_info=None):
    ...
    # skip saturation if it doesn't reduce the FDR
    ...
    if not options.no_saturation and saturation_spectrum_info:
        ...
        #    remaining_spectrum_info_1 = remaining_spectrum_info_s
        #else:
        #    print "skipping unproductive saturation"
